...
public enum OpenApiErrorCode {
    ...
    RESOURCE_CONFLICT(409,"R-3001","요청 하신 리소스가 이미 존재 합니다."),

    ///////////////////////
    // Business Error
    BUSINESS_ERROR(500,"B-4000","API 처리 중 문제가 발생 하였습니다. 캠핑톡에 문의 부탁 드립니다."),

    // - data, format, validation
    INVALID_PARAMETER_ERROR(500,"B-4100","파라메터가 잘못되었습니다."),
    EXTRA_INFO_INVALID_ERROR(500,"B-4101","추가 정보 처리 중 문제가 발생 하였습니다. 캠핑톡에 문의 부탁 드립니다."),

    // - process noti
    BOOKING_NOT_FOUND(404,"B-4200","예약 정보가 없습니다."),
    BOOKING_CHECKIN_CANNOT_QUERY_PAST_DAY(500,"B-4201","예약 체크인 정보는 과거 데이터 조회가 불가능 합니다."),
